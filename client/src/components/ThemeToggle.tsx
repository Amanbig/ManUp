...
export default function ThemeToggle({ theme, onThemeChange, compact = false }: ThemeToggleProps) {
  ...
  if (compact) {
    return (
      <button
        onClick={cycleTheme}
        className="p-2 rounded-lg border border-neutral-800 hover:bg-neutral-900 text-neutral-400 hover:text-neutral-200 transition shrink-0"
  ...
  return (
    <div className="inline-flex items-center rounded-lg border border-neutral-800 bg-neutral-950 p-1 text-xs">
      <button
        type="button"
