...
export default function ProjectWorkspaceView({
  ...
  return (
    <div className="space-y-6 font-sans max-w-7xl mx-auto">
      ...
      {/* Secrets Management Bar & Content */}
      {environments.length === 0 ? (
        <div className="border border-dashed border-neutral-300 dark:border-neutral-800 rounded-3xl p-12 text-center bg-white dark:bg-neutral-950/20 shadow-xs my-6">
          ...
          <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1.5 max-w-md mx-auto leading-relaxed">
            Secrets in ManUp belong to an environment (such as Development, Staging, or Production).
            Create your first environment to start adding and managing secrets.
          </p>
          {projRole === 'admin' ? (
            <div className="mt-6 flex items-center justify-center">
              <button
                onClick={onCreateEnvironment}
                className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-500 hover:to-red-500 text-white rounded-xl text-xs font-semibold transition shadow-md shadow-orange-600/15 cursor-pointer"
              >
            ...
            <p className="text-xs text-neutral-500 mt-4">
              Please contact a project administrator to create an environment.
            </p>
          )}
        </div>
      ) : (
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {envRole !== 'viewer' && (
                <button
                  ...
                  title={!selectedEnvironment ? 'Select or create an environment first' : undefined}
              ...
              <table className="w-full text-left border-collapse text-sm">
                <thead>
                  <tr className="border-b border-neutral-200 dark:border-neutral-900 bg-neutral-50/70 dark:bg-neutral-900/40 text-neutral-600 dark:text-neutral-400 font-semibold text-xs">
                    ...
                    <th className="px-6 py-3.5 font-semibold uppercase tracking-wider text-[11px]">
                      Key
                    </th>
                    <th className="px-6 py-3.5 font-semibold uppercase tracking-wider text-[11px]">
                      Value
                    ...
                    {envRole !== 'viewer' && (
                      <th className="px-6 py-3.5 text-right font-semibold uppercase tracking-wider text-[11px]">
                        Actions
                      </th>
                    )}
                  </tr>
                ...
                <tbody className="divide-y divide-neutral-200 dark:divide-neutral-900 font-mono">
                  {filteredSecrets.map((secret) => {
                    ...
                    return (
                      <tr
                        key={secret.id}
                        className={`group transition hover:bg-neutral-50/80 dark:hover:bg-neutral-900/30 ${
                      ...
                      >
                        ...
                        <td className="px-6 py-4 font-semibold text-neutral-900 dark:text-neutral-100">
                          {isEditing ? (
                            <input
                              ...
                              className="w-full bg-white dark:bg-neutral-950 border border-neutral-300 dark:border-neutral-700 rounded-lg px-2.5 py-1 text-xs outline-none focus:border-orange-500"
                            />
                          ) : (
                        ...
                        <td className="px-6 py-4 text-neutral-500 text-xs font-sans">
                              ...
                              {isEditing ? (
                                <>
                                  <button
                                    ...
                                    className="p-1.5 rounded-lg bg-orange-600 hover:bg-orange-500 text-white transition"
                                    title="Save Secret"
                                  >
                                  ...
                                  <button
                                    ...
                                    className="p-1.5 rounded-lg border border-neutral-300 dark:border-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-800 text-neutral-500 transition"
                                    title="Cancel"
                                  >
                                ...
                                <>
                                  <button
                                    ...
                                    className="p-1.5 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-white transition"
                                    title="Copy Value"
                                  >
                                    {copiedId === secret.id ? (
              ...
              <div className="mt-6 flex items-center justify-center gap-3">
                {searchQuery ? (
                  ...
                  <button
                    onClick={onAddSecretClick}
                    disabled={!selectedEnvironment}
                    className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-500 hover:to-red-500 text-white rounded-xl text-xs font-semibold transition disabled:opacity-50 shadow-md shadow-orange-600/15 cursor-pointer"
                  >
                    <Plus className="h-4 w-4" />
